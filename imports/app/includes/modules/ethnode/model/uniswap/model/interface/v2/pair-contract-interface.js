...
var PairContractInterface = /*#__PURE__*/function () {
  function PairContractInterface(session, contractaddress, web3providerurl) {
    _classCallCheck(this, PairContractInterface);
  ...
  _createClass(PairContractInterface, [{
    ...
    key: "getReserves",
    value: function () {
      var _getReserves = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var contractinstance, args, reserves;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                args = [];
                _context.next = 4;
                return contractinstance.method_call('getReserves', args);
