...
var FactoryContractInterface = /*#__PURE__*/function () {
  function FactoryContractInterface(session, contractaddress, web3providerurl) {
    _classCallCheck(this, FactoryContractInterface);
  ...
  _createClass(FactoryContractInterface, [{
    ...
    key: "getPairAddress",
    value: function () {
      var _getPairAddress = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token1_address, token2_address) {
        var contractinstance, args, pair_address;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return contractinstance.method_call('getPair', args);

              case 6:
                pair_address = _context.sent;
                return _context.abrupt("return", pair_address);
      ...
      function getPairAddress(_x, _x2) {
  ...
  return FactoryContractInterface;
}();
