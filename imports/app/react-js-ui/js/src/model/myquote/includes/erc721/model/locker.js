...
var Locker = /*#__PURE__*/function () {
  function Locker(session, contractaddress, web3providerurl) {
    _classCallCheck(this, Locker);

    this.session = session;
    this.address = contractaddress;
    this.web3providerurl = web3providerurl;
    this.contractpath = './contracts/deeds_v1/Locker.json'; // operating variables
  ...
  _createClass(Locker, [{
    key: "getContractPath",
    value: function getContractPath() {
      return this.contractpath;
    }
  }, {
    key: "setContractPath",
    value: function setContractPath(path) {
    ...
    key: "store",
    value: function () {
      var _store = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(valstr, ethtx) {
        var contractinstance, fromaccount, payingaccount, gas, gasPrice, transactionuuid, value, contracttransaction, args;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                contractinstance = this.getContractInstance();
                fromaccount = ethtx.getFromAccount();
                ...
                args.push(valstr);
                contracttransaction.setArguments(args);
                return _context.abrupt("return", contractinstance.method_send(contracttransaction));
    ...
    key: "retrieve",
    value: function () {
      var _retrieve = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(client_address) {
        var contractinstance, params, valstr;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return contractinstance.method_call('retrieve', params);

              case 5:
                valstr = _context2.sent;
                return _context2.abrupt("return", valstr);
    ...
    key: "register",
    value: function () {
      var _register = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(valstr, ethtx) {
        var contractinstance, fromaccount, payingaccount, gas, gasPrice, transactionuuid, value, contracttransaction, args;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                args.push(valstr);
                contracttransaction.setArguments(args);
                return _context3.abrupt("return", contractinstance.method_send(contracttransaction));
    ...
    key: "fetch",
    value: function () {
      var _fetch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(client_address) {
        var contractinstance, params, arr;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                params.push(client_address);
                _context4.next = 5;
                return contractinstance.method_call('fetch', params);
