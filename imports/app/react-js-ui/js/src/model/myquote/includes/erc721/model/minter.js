...
var Minter = /*#__PURE__*/function (_ERC721TokenClass) {
  _inherits(Minter, _ERC721TokenClass);

  var _super = _createSuper(Minter);

  function Minter(session, contractaddress, web3providerurl) {
    _classCallCheck(this, Minter);

    return _super.call(this, session, contractaddress, web3providerurl);
  }
  ...
  _createClass(Minter, [{
    ...
    key: "registerRecord",
    value: function () {
      var _registerRecord = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tokenId, valstr, ethtx) {
        var contractinstance, fromaccount, payingaccount, gas, gasPrice, transactionuuid, value, contracttransaction, args, _tokenId;
      ...
      function registerRecord(_x, _x2, _x3) {
        return _registerRecord.apply(this, arguments);
      }
    ...
    key: "fetchRecords",
    value: function () {
      var _fetchRecords = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tokenId) {
        var contractinstance, params, _tokenId, arr;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 6;
                return contractinstance.method_call('fetchRecords', params);
