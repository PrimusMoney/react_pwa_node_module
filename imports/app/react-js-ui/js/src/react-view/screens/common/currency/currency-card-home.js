...
var _currencyCardView = _interopRequireDefault(require("../../../components/common/currency/currency-card-view.js"));
...
var CurrencyCardHomeScreen = /*#__PURE__*/function (_React$Component) {
  _inherits(CurrencyCardHomeScreen, _React$Component);

  var _super = _createSuper(CurrencyCardHomeScreen);

  function CurrencyCardHomeScreen(props) {
    var _this;

    _classCallCheck(this, CurrencyCardHomeScreen);
  ...
  _createClass(CurrencyCardHomeScreen, [{
    ...
    value: function () {
      var _checkNavigationState = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var mvcmyquote, rootsessionuuid, app_nav_target;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                app_nav_target = this.app.getNavigationState('target');
                this.setState({
                  loaded: true
                });
    ...
    key: "onRefreshPage",
    value: function () {
      var _onRefreshPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                console.log('CurrencyCardHomeScreen.onRefreshPage called');
                return _context2.abrupt("return", this.checkNavigationState()["catch"](function (err) {
                  console.log('error in checkNavigationState: ' + err);
                }));
    ...
    key: "renderCardView",
    value: function renderCardView() {
      switch (this.state.action) {
        case 'view':
          return /*#__PURE__*/_react["default"].createElement(_currencyCardView["default"], {
            app: this.app
          });

        case 'load':
          return /*#__PURE__*/_react["default"].createElement("div", null, "Not implemented ", this.state.action);

        default:
          return /*#__PURE__*/_react["default"].createElement("div", null, "Error, wrong action ", this.state.action);
      }
    }
  }, {
    key: "render",
    value: function render() {
      var _this$state = this.state,
          ...
          cardinfo = _this$state.cardinfo;
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: "Screen"
      }, /*#__PURE__*/_react["default"].createElement(_header["default"], {
        app: this.app
      }), loaded === true ? this.renderCardView() : /*#__PURE__*/_react["default"].createElement("div", null, cardinfo));
    }
  }]);

  return CurrencyCardHomeScreen;
