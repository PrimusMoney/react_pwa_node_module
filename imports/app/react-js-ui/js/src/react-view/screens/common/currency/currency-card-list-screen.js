...
var _currencyCardListView = _interopRequireDefault(require("../../../components/common/currency/currency-card-list-view.js"));
...
var CurrencyCardListScreen = /*#__PURE__*/function (_React$Component) {
  _inherits(CurrencyCardListScreen, _React$Component);

  var _super = _createSuper(CurrencyCardListScreen);

  function CurrencyCardListScreen(props) {
    var _this;

    _classCallCheck(this, CurrencyCardListScreen);
  ...
  _createClass(CurrencyCardListScreen, [{
    ...
    value: function () {
      var _checkNavigationState = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var mvcmyquote, rootsessionuuid, app_nav_state, app_nav_target, params, currencyuuid, currencyinfo, action;
              ...
              case 0:
                ...
                if (app_nav_target && app_nav_target.route == 'currencycards' && app_nav_target.reached == false) {
                  ...
                  if (params) {
                    ...
                    currencyinfo = '';
                    action = params.action ? params.action : 'view';
    ...
    value: function render() {
      var _this$state = this.state,
          ...
          currencyinfo = _this$state.currencyinfo;
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: "Screen"
      }, /*#__PURE__*/_react["default"].createElement(_header["default"], {
        app: this.app
      }), loaded === true ? /*#__PURE__*/_react["default"].createElement(_currencyCardListView["default"], {
        app: this.app
      }) : /*#__PURE__*/_react["default"].createElement("div", null, currencyinfo));
    }
  }]);

  return CurrencyCardListScreen;
