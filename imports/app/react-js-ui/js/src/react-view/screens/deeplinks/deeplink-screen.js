...
exports["default"] = exports.DeepLinkScreen = void 0;
...
var DeepLinkScreen = /*#__PURE__*/function (_React$Component) {
  _inherits(DeepLinkScreen, _React$Component);

  var _super = _createSuper(DeepLinkScreen);

  function DeepLinkScreen(props) {
    var _this;

    _classCallCheck(this, DeepLinkScreen);
  ...
  _createClass(DeepLinkScreen, [{
    key: "componentDidMount",
    value: function componentDidMount(prevProps) {
      console.log('DeepLinkScreen.componentDidMount called');
      var app_nav_state = this.app.getNavigationState();
      var app_nav_target = app_nav_state.target;
      ...
      if (app_nav_target && app_nav_target.route == 'deeplink' && app_nav_target.reached == false) {
        ...
        var app_start_conditions = this.app.getVariable('start_conditions');
        var urlParams = app_start_conditions.urlParams;

        var _url;

        var _encodedurl = urlParams.get('linkurl');

        if (_encodedurl) {
          if (_encodedurl.startsWith('b64_')) _url = this.app.decodebase64(_encodedurl.substring(4));else if (_encodedurl.startsWith('hex_')) _url = this.app.decodehex(_encodedurl.substring(4));
          this.setState({
            url: _url
          });
        }
    ...
    key: "onGotoLink",
    value: function () {
      var _onGotoLink = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var url;
      ...
      function onGotoLink() {
        return _onGotoLink.apply(this, arguments);
      }

      return onGotoLink;
    }()
  }, {
    key: "renderDeepLinkForm",
    value: function renderDeepLinkForm() {
      var _this2 = this;
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        onClick: this.onGotoLink.bind(this),
        type: "submit"
      }, "Go")));
    }
  }, {
...
exports.DeepLinkScreen = DeepLinkScreen;
