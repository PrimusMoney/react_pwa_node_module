...
var SplashScreen = /*#__PURE__*/function (_React$Component) {
  ...
  function SplashScreen(props) {
    ...
    _this.exec_env = _this.app.exec_env;
    _this.uuid = _this.app.guid();
    var dev_message = '';
    if (_this.exec_env == 'dev') dev_message = 'waiting for dev environment info...';
    _this.state = {
  ...
  _createClass(SplashScreen, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.exec_env != 'dev') return;
      var app = this.app;
      var mvcmyquote = app.getMvcMyQuoteObject();
      if (mvcmyquote) mvcmyquote.registerEventListener('on_app_refresh_logs', this.uuid, this.onRefreshLogs);
    } // end of life
    ...
    value: function componentWillUnmount() {
      ...
      var app = this.app;
      var mvcmyquote = app.getMvcMyQuoteObject();
      if (mvcmyquote) mvcmyquote.unregisterEventListener('on_app_refresh_logs', this.uuid);
    }
  }, {
    key: "onRefreshLogs",
    value: function () {
      var _onRefreshLogs = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var now;
      ...
      function onRefreshLogs() {
        return _onRefreshLogs.apply(this, arguments);
      }
    ...
    key: "renderDebugLogs",
    value: function renderDebugLogs() {
    ...
    value: function render() {
      return /*#__PURE__*/_react["default"].createElement("div", null, this.renderSplashInfo());
    }
  }]);
